# -*- coding: utf-8 -*-
"""
Created on Wed Jan 10 11:46:58 2018
...
def split_canada_contributions(canada_dstn, idv_df, canada_model_estimate):
	...
	tmp = pd.melt(canada_model_estimate.reset_index().rename(columns={'index_col':'Model'}),id_vars=['Model']).dropna()
...
#      model_estimate = data['model_estimate']
      tmp_contribution = split_canada_contributions(canada_split,test_data, model_estimate.loc[model_estimate.index.str.startswith('C'),:])
